...
async def create_receiver(receiver: receiver_schema.ReceiverCreate,) -> receiver_schema.Receiver:
...
async def update_receiver(receiver_id: int, receiver_update: receiver_schema.ReceiverUpdate) -> receiver_schema.Receiver:
...
async def patch_receiver(receiver_id: int, receiver_update: receiver_schema.ReceiverUpdate) -> receiver_schema.Receiver:
